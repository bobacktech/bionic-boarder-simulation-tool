...
import os
import pytest
from bionic_boarder_simulation_tool.main import AppInputArguments


def test_load_and_validate_app_input_arguments_json():
    script_dir = os.path.dirname(__file__)
    schema_path = os.path.join(script_dir, "../../bionic_boarder_simulation_tool/app_input_arguments.schema.json")
